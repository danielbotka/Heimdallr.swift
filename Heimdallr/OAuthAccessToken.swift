...
public class OAuthAccessToken: NSObject {
  ...
  public init(accessToken: String, tokenType: String, expiresAt: Date? = nil, refreshToken: String? = nil, customProperties: [String:Any]? = nil) {
  ...
  public func copy(accessToken: String? = nil, tokenType: String? = nil, expiresAt: Date?? = nil, refreshToken: String?? = nil, customProperties: [String: Any]? = nil) -> OAuthAccessToken {
    return OAuthAccessToken(accessToken: accessToken ?? self.accessToken,
                            tokenType: tokenType ?? self.tokenType,
                            expiresAt: expiresAt ?? self.expiresAt,
                            refreshToken: refreshToken ?? self.refreshToken,
                            customProperties: customProperties ?? self.customProperties)
  }
}
...
extension OAuthAccessToken {
  public class func decode(_ json: [String: AnyObject]) -> OAuthAccessToken? {
    ...
    var customProperties = json
    customProperties.removeValue(forKey: "access_token")
    customProperties.removeValue(forKey: "token_type")
    customProperties.removeValue(forKey: "expires_in")
    customProperties.removeValue(forKey: "refresh_token")
